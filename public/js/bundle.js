      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Logout fail please try again');
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic3VwZXJsdW4iLCJhIjoiY2s4Y3B1ZWJmMGo2dzNscWV3eWc1cWdmZCJ9.99pRtW9wQoYp9LYfXXK4NA';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("Day ".concat(loc.day, ": ").concat(loc.description)).addTo(map);
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:6600/api/v1/users/updateMyPassword' : 'http://127.0.0.1:6600/api/v1/users/updateMe';
            console.log(url);
            _context.next = 5;
            return (0, _axios.default)({
              method: 'PATCH',
...
var stripe = Stripe('pk_test_GX1f7FqLRCzwCMEeZQU2itn800niDIKZEU'); // https://stripe.com/docs/payments/checkout/one-time
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://127.0.0.1:6600/api/v1/booking/checkout-session/".concat(tourId));
